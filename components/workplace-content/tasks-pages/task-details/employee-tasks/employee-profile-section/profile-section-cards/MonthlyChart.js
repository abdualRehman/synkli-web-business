    ...
    <div>
      ...
      <div className="p-2  all-emp-wrapper ">
        ...
        <VictoryChart
          ...
          domainPadding={20}
          padding={{ top: 10, bottom: 40, left: 40, right: 5 }}
        >
          <VictoryAxis
            tickValues={stats.map((item) => item.month)}
            tickFormat={stats?.length && yearlyStats?.map((item) => item.month)}
            style={{
