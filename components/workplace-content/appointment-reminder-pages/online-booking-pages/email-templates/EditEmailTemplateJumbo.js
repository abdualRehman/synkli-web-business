        ...
        <div className="profile-jumbo-flex px-10 py-5">
          <div className="jumbo-flex-1 ">
            <div className="flex gap-2 items-center">
              ...
              <div className="jumbo-name">Edit Email Template</div>
            </div>
            <div className="jumbo-dir mt-2">
              Workspace &gt; Appointments &gt; Online Booking &gt; Email
              Templates{" "}
...
export default EditEmailTemplateJumbo;
