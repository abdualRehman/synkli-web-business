...
const AnnouncementDetails = ({ toggleAnnDetails, ann }) => {
  return (
        ...
        >
          <div>
            ...
            <div className="add-detail pt-10 px-5">
              <div className="title">Announcement details</div>
          ...
          <div className="ann-detail-img-wrapper mt-3">
            <img src={ann.src} alt="annimg" className="ann-detail-img" />
          </div>

          <div className="ann-detais px-5 mt-5">
            <div className="ann-detail-legend flex justify-between">
              <div className="ann-detail-title tab-font">
                Important Announcement
              </div>
              <div className="ann-info">
                <div className="tab-font"> {ann.date}</div>
                <div className="tab-font">
                  By <span className="text-blue-900">{ann.by}</span>{" "}
                </div>
              </div>
            </div>

            <div className="ann-detail-text tab-font mt-2">
              {ann.description.repeat(5)}
            </div>
          ...
          <div className="add-service-bottom">
            <button className="ann-remove-btn px-5 md:px-20 py-2 cursor-pointer tab-font rounded-xl">
              Upload
            </button>
          </div>
        </motion.div>
