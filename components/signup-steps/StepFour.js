...
const StepFour = (props) => {
    ...
    dispatch(setPasswordThunk(formData))
      .then((response) => {
        if (response.payload) {
          ...
          navigate("/signup/registration/successfull");
        }
      })
      .catch((error) => {
        console.log(error);
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center set-password-wrap">
                ...
                <div className="mt-5 ">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span onClick={showStepSix} className="cursor-pointer">
                        {" "}
                        Terms and Conditions
                      </span>{" "}
                      and{" "}
                      <span onClick={showStepSeven} className="cursor-pointer">
                        {" "}
                        Privacy Policy
                      </span>
                    </div>
