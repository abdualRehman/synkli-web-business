...
const TaskOperationTraining = ({
  ...
  useEffect(() => {
    driverObj.highlight({
      element: ".task-settings-indicator",
      popover: {
        ...
        <div className="tasks-operations-container">
          <div className="flex items-center justify-between flex-wrap gap-5 mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="gap-2  tasks-reports-btn mt-1 rounded-md px-2 task-settings-indicator">
                ...
                <div
                  onClick={() => {
                    driverObj.destroy();
                    navigate("/organizational/training");
                  }}
...
export default TaskOperationTraining;
