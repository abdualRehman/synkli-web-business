...
export const AnnualLeave = ({ toggleAnnualLeave }) => {
  return (
          ...
          <div>
            ...
            <div className="add-detail pt-10 px-5">
              ...
              <div className="jumbo-dir mt-2">
                Payroll &gt; Leave{" "}
                <span className="special-jumbo-text"> &gt; Annual Leave</span>
              </div>
            </div>
          </div>

          <div className="add-ann-form mt-3 mx-5">
            <div>
              {" "}
            ...
            <div>
              <input type="text" placeholder="Leave Period" />
            </div>
            ...
            <div className="mt-2">
              ...
              <div className="leave-text-container">
                <textarea
                  ...
                  cols="30"
                  rows="10"
                  className="leave-text-area"
                ></textarea>
                <div className="leave-text-icon">
                  <svg
                    width="28"
                    height="28"
                    viewBox="0 0 32 32"
