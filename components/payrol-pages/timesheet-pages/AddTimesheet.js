...
export const AddTimesheet = ({ toggleAddTimesheet }) => {
  return (
          ...
          <div>
            ...
            <div className="add-detail pt-10 px-5">
              ...
              <div className="jumbo-dir mt-2">
                Payroll{" "}
                <span className="special-jumbo-text"> &gt; Timesheet</span>
              </div>
            </div>
          </div>
          <div className="add-timesheet-wrapper ">
            <div className="mx-5 mt-2 add-ann-form">
              <div className="search-emp-layer">
                <select>
              ...
              <div className="mt-3 grid grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div className="leave-loading-container">
                    ...
                    />
                    <button className="leave-loading-btn timesheet-input-btn">
                      min
                    </button>
                  </div>
                </div>
