      ...
      <div className="profile-jumbo-flex">
        <div className="jumbo-flex-1 flex flex-col w-full relative">
          ...
          <div className="jumbo-dir md:mt-2">
            Payroll{" "}
            <span className="special-jumbo-text">&gt; Finalize STP</span>
          </div>

          <div className="grid grid-cols-2  md:absolute right-5 top-5">
            <button className="stp-select-date-btn px-5 py-1">
              {" "}
              <select>
                {" "}
            ...
            <button className="stp-finalised-btn">Finalised</button>
          </div>
        </div>
      </div>
    </div>
...
export default FinilizeSTPJumbo;
