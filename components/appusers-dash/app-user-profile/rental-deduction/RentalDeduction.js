        ...
        >
          <div>
            ...
            <div className="add-detail pt-5 px-5">
              <div className="title">Rental Deduction</div>
            </div>
          </div>
          ...
          <div className="px-5 flex justify-between deduction-counter">
...
export default RentalDeduction;
