...
const TfnDeduction = ({ toggleTfnDeduction }) => {
  ...
  const [deductions, setDeductions] = useState([
    { id: 1, address: "Core Plan Management", names: "Mr. Raj/Mr. Alpha" },
        ...
        >
          <div>
            ...
            <div className="add-detail pt-5 px-5">
              <div className="title">TFN Deduction</div>
            </div>
          </div>
          ...
          <div className="px-5 flex justify-between deduction-counter mb-2">
