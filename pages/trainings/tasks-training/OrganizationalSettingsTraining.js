...
import AddDynamicStatus from "components/trainings-components/task-training-components/organizational-settings-pages/AddDynamicStatus";
import { Logs } from "components/workplace-content/tasks-pages/organizational-settings-pages/Logs";
import OrganizationalSettingsPageComponent from "components/trainings-components/task-training-components/OrganizationalSettingsPageComponent";
const OrganizationalSettingsTraining = () => {
  ...
  return (
    <div className="app-dashboard">
      ...
      <div className={`content ${isOpen ? "squeeze" : ""}`}>
        <OrganizationalSettingsPageComponent
          showAddStatus={showAddStatus}
          toggleAddStatus={toggleAddStatus}
...
export default OrganizationalSettingsTraining;
